...
public class PoolableManagedConnection extends PoolableConnection {
     ...
     * @param conn                underlying connection
     * @param pool                connection pool
     * @param disconnectSqlCodes  SQL State codes considered fatal disconnection errors
     ...
     * @param pool                        connection pool
     * @param disconnectSqlCodes          SQL State codes considered fatal disconnection errors
     * @param disconnectionIgnoreSqlCodes SQL State codes considered fatal disconnection errors
     * @param fastFailValidation          true means fatal disconnection errors cause subsequent validations to fail immediately (no attempt to
     *                                    run query or isValid)
     * @since 2.13.0
     */
